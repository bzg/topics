...
- Send a [[mailto:~bzg/dev@lists.sr.ht?subject=\[BUG\] topics: <SHORT EXPLICIT BUG DESCRIPTION>][bug report]]
- Send a [[mailto:~bzg/dev@lists.sr.ht?subject=\[PATCH\] topics: <COMMIT SUMMARY>][patch]] (please use =git format-patch=)
- Send a [[mailto:~bzg/dev@lists.sr.ht?subject=\[FR\] topics: <FEATURE REQUEST>][feature request]]
- Share any [[mailto:~bzg/dev@lists.sr.ht?subject=topics: <ANYTHING>][other question or idea]]
